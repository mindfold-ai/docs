...
`trellis-spec-bootstrap` 帮助 AI 从真实仓库创建或刷新 `.trellis/spec/` 规则。它是 platform-neutral 的：一个能力足够的 agent 可以分析代码库、选择 spec 边界、写文档，并确认没有留下占位内容。
...
`trellis-spec-bootstrap` 随 Trellis 内置安装。安装或更新 Trellis 后可以直接使用这个 skill，不需要再从 marketplace 单独下载。
