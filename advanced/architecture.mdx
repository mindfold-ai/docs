...
| `prd.md`          | Goal, Requirements, and User-visible Outcomes; technical design, execution, and evidence live in companion artifacts. |
...
## PRD contract boundary

The task system keeps product intent in the three fixed PRD sections and puts technical design, execution, and evidence in their own artifacts.
