...
- Drafts and iterates `prd.md` with Goal, Requirements, and User-visible Outcomes.
...
Use the fixed Goal, Requirements, and User-visible Outcomes contract before `task.py start`. A UI prototype remains `pending_user_approval` until the user explicitly approves it.
