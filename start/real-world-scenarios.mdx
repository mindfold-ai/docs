...
1. Let workspace admins invite teammates by email and manage pending invites.
...
## Planning example boundary

Keep user goals, required behavior, and observable outcomes in the PRD; move implementation details and repository evidence to their dedicated artifacts.
