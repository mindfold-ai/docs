...
| ----------------- | --------------------------- | --------------------------------------------------------------------------------------- |
| `prd.md`          | every task                  | Goal, Requirements, and User-visible Outcomes; technical design, execution, and evidence live in companion artifacts. |
...
The PRD is the human-readable contract: `Goal`, `Requirements`, then `User-visible Outcomes`. Technical design, execution commands, and source evidence belong in `design.md`, `implement.md`, and `research/`.
