...
<Note>
  Sub-agents ship on 18 of 22 configured platforms: Claude Code, Cursor, OpenCode, Codex, Kiro,
  ...
  sub-agent primitive — the implement / check work runs inline in the main session, and DeepSeek
